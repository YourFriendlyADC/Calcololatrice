...
public class frameCld extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(plus, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, 60, 60));
        ...
        bg.add(divide, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 350, 60, 60));
        ...
        bg.add(deleteOne, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 350, 60, 60));
        ...
        bg.add(minus, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 210, 60, 60));
        ...
        bg.add(n3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, 60, 60));
        ...
        bg.add(n1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 60, 60));
        ...
        bg.add(n2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 60, 60));
        ...
        bg.add(n6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, 60, 60));
        ...
        bg.add(n4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 60, 60));
        ...
        bg.add(n5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, 60, 60));
        ...
        bg.add(n9, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, 60, 60));
        ...
        bg.add(n7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 60, 60));
        ...
        bg.add(n8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 280, 60, 60));
        ...
        bg.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 60, 60));
        ...
        bg.add(n0, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 350, 60, 60));
        ...
        bg.add(equal, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 350, 60, 60));
        ...
        bg.add(show, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 340, 60));
        ...
        bg.add(toG, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 50, 30));
        ...
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 70, -1));
        ...
        bg.add(toB, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 50, 30));
        ...
        bg.add(times, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 280, 60, 60));
        ...
        bg.add(potency, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 140, 60, 60));
        ...
        bg.add(toR, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 20, 50, 30));
        ...
        bg.add(toY, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 50, 30));
        ...
        bg.add(square, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 210, 60, 60));
        ...
        bg.add(factorial, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, 60, 60));

        jLabel3.setFont(new java.awt.Font("MV Boli", 1, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 51, 51));
        jLabel3.setText("Soon");
        bg.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 40, -1));

        jLabel4.setFont(new java.awt.Font("MV Boli", 1, 16)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Soon");
        bg.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 40, -1));

        jLabel5.setFont(new java.awt.Font("MV Boli", 1, 17)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(51, 51, 51));
        jLabel5.setText("Soon");
        bg.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 50, 30));

        jLabel6.setFont(new java.awt.Font("MV Boli", 1, 17)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(51, 51, 51));
        jLabel6.setText("Soon");
        bg.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 50, 30));

        jLabel7.setFont(new java.awt.Font("MV Boli", 1, 17)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 51, 51));
        jLabel7.setText("Soon");
        bg.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 50, 30));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(bg, javax.swing.GroupLayout.DEFAULT_SIZE, 432, Short.MAX_VALUE)
        );
        ...
        for (int i = 0; i < showText.length(); i++) {
            ...
            if (pass == false) {
                ...
                if ("+".equals(extract) || "-".equals(extract) || "*".equals(extract) || "/".equals(extract) || "^".equals(extract) || "√".equals(extract) || "!".equals(extract)) {
                    ...
                    operators[o] = operators[o] + extract;                
                }
        }
        o = 0;
        while (!"".equals(operators[o])) {
            iOperators[o] = Integer.parseInt(operators[0]);
            o++;
        }
        //calc(iOperators, sign, o);
        }
...
//    public void calc(int iOperators, String sign, int o) {
//        int result = 0;
//        switch (sign) {
//            case "+":
//                result = nOne + nTwo;
